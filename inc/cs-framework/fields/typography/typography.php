...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. __( 'Web Safe Fonts', 'advance-wordpress' ) .'">';
      ...
      echo '<optgroup label="'. __( 'Google Fonts', 'advance-wordpress' ) .'">';
      ...
      echo __( 'Error! Can not load json file.', 'advance-wordpress' );
