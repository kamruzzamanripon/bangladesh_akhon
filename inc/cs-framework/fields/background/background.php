...
class CSFramework_Option_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : __( 'Upload', 'advance-wordpress' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : __( 'Upload', 'advance-wordpress' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : __( 'Use Image', 'advance-wordpress' );
